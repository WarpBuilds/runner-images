...
build {
  ...
  #       project_id      = "your-gcp-project-id"
  #       account_file    = "path/to/your-service-account-key.json"
  #       image_family    = "gcp-image-family"
  #       image_description = "GCP image description"
  #       machine_type    = "n1-standard-1"
  #       disk_size       = "10GB"
  #       disk_type       = "pd-standard"
  #       zone            = "us-central1-a"
  #       ssh_username    = "your-ssh-username"
  #       image_hypervisor = "kvm"
  ...
  # }
    ...
    post-processor "googlecompute-import" {
      source_image_name   = "gcp-image-name"
      source_image_family = "gcp-image-family"
      network            = "default"
      compute_disk_size_gb = 1
    }
}
